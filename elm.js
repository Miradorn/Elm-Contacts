...
Elm.ContactBook.make = function (_elm) {
   ...
   F7(function (v0,v1,v2,v3,v4,v5,v6) {
      return {ctor: "_Tuple7"
             ,_0: v0
             ,_1: v1
             ,_2: v2
   ...
   var stringHasContent = F2(function (query,string) {
      return A2($String.contains,
      $String.toLower(query),
      $String.toLower(string));
   });
   var stringsHaveContent = F2(function (query,strings) {
      return A2($List.any,stringHasContent(query),strings);
   });
   var categoryHasContent = F2(function (query,category) {
      return A2(stringsHaveContent,
      query,
      _U.list([category.name.string,category.color.string]));
   });
   var contactHasContent = F2(function (query,contact) {
      var inCategory = function () {
         var _p0 = contact.categoryObject;
         if (_p0.ctor === "Just") {
               return A2(categoryHasContent,query,_p0._0);
            } else {
               return false;
            }
      }();
      var contentContactFilter = function (content) {
         return A2(stringHasContent,query,content.text.string);
      };
      return A2(stringsHaveContent,
      query,
      _U.list([contact.name.string
              ,contact.company.string
              ,contact.birthday.string])) || (A2($List.any,
      contentContactFilter,
      contact.addresses) || (A2($List.any,
      contentContactFilter,
      contact.emails) || (A2($List.any,
      contentContactFilter,
      contact.phones) || inCategory)));
   });
   var contactsWithCategory = F2(function (contacts,categoryID) {
      return A2($List.filter,
      function (contact) {
         return _U.eq(contact.category,categoryID);
      },
      contacts);
   });
   ...
   var blankStyle = {padding: $Graphics$Input$Field.uniformly(0)
                    ...
                    ,style: $Text.defaultStyle};
   var ModifyContactContent = F2(function (a,b) {
      return {ctor: "ModifyContactContent",_0: a,_1: b};
   });
   var viewForContactContent = F3(function (address,
   content,
   removeButton) {
      return A2($Html.li,
      _U.list([]),
   ...
   var RemoveContact = function (a) {
      return {ctor: "RemoveContact",_0: a};
   };
   var RemoveEmail = F2(function (a,b) {
      return {ctor: "RemoveEmail",_0: a,_1: b};
   });
   var RemovePhone = F2(function (a,b) {
      return {ctor: "RemovePhone",_0: a,_1: b};
   });
   var RemoveAddress = F2(function (a,b) {
      return {ctor: "RemoveAddress",_0: a,_1: b};
   });
   var AddEmail = function (a) {
      return {ctor: "AddEmail",_0: a};
   };
   var AddPhone = function (a) {
      return {ctor: "AddPhone",_0: a};
   };
   var AddAddress = function (a) {
      return {ctor: "AddAddress",_0: a};
   };
   var viewForContact = F2(function (address,contact) {
      var addPhoneButton = A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,AddPhone(contact.id))
              ,$Html$Attributes.$class("small")]),
      _U.list([$Html.text("Add phone")]));
      var addEmailButton = A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,AddEmail(contact.id))
              ,$Html$Attributes.$class("small")]),
      _U.list([$Html.text("Add email")]));
      var addAddressButton = A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,AddAddress(contact.id))
              ,$Html$Attributes.$class("small")]),
      _U.list([$Html.text("Add address")]));
      var deleteButton = A2($Html.button,
      ...
      var contentViewMapper = F2(function (remAddress,content) {
         return A3(viewForContactContent,
         address,
         content,
         A2($Html.button,
         _U.list([A2($Html$Events.onClick,address,remAddress)
                 ,$Html$Attributes.$class("small")]),
         _U.list([$Html.text("X")])));
      });
      var addresses = A2($List.map,
      function (content) {
         return A2(contentViewMapper,
         A2(RemoveAddress,contact.id,content.id),
         content);
      },
      contact.addresses);
      var phones = A2($List.map,
      function (content) {
         return A2(contentViewMapper,
         A2(RemovePhone,contact.id,content.id),
         content);
      },
      contact.phones);
      var mails = A2($List.map,
      function (content) {
         return A2(contentViewMapper,
         A2(RemoveEmail,contact.id,content.id),
         content);
      },
      contact.emails);
      var buildDL = $List.map(function (_p1) {
         var _p2 = _p1;
         return A2($Html.li,
         _U.list([]),
         _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text(_p2._0)]))
                 ,A2($Html.div,
      ...
      $Signal.message(A2($Signal.forwardTo,
      address,
      ModifyContactCompany(contact.id))),
      "Name",
      contact.company);
      ...
      "Name",
      contact.name);
      var dL = _U.list([{ctor: "_Tuple2"
                        ,_0: "Name"
                        ,_1: $Html.fromElement(nameField)}
                       ,{ctor: "_Tuple2"
                        ,_0: "Company"
                        ,_1: $Html.fromElement(companyField)}
                       ,{ctor: "_Tuple2"
                        ,_0: "Birthday"
                        ,_1: $Html.fromElement(birthdayField)}
                       ,{ctor: "_Tuple2"
                        ,_0: "Addresses"
                        ,_1: A2($Html.ul,_U.list([]),addresses)}
                       ,{ctor: "_Tuple2"
                        ,_0: "Phone numbers"
                        ,_1: A2($Html.ul,_U.list([]),phones)}
                       ,{ctor: "_Tuple2"
                        ,_0: "E-Mails"
                        ,_1: A2($Html.ul,_U.list([]),mails)}
                       ,{ctor: "_Tuple2"
                        ,_0: "Actions"
                        ,_1: A2($Html.span,
                        _U.list([$Html$Attributes.$class("contact_actions")]),
                        _U.list([deleteButton
                                ,addAddressButton
                                ,addEmailButton
                                ,addPhoneButton]))}]);
      var dLC = function () {
         var _p3 = contact.categoryObject;
         if (_p3.ctor === "Just") {
               var _p4 = _p3._0;
   ...
   var ModifyCategoryColor = F2(function (a,b) {
      return {ctor: "ModifyCategoryColor",_0: a,_1: b};
   });
   var ModifyCategoryName = F2(function (a,b) {
      return {ctor: "ModifyCategoryName",_0: a,_1: b};
   });
   var RemoveCategory = function (a) {
      return {ctor: "RemoveCategory",_0: a};
   };
   var Filter = function (a) {    return {ctor: "Filter",_0: a};};
   var queryUpdateMessage = F2(function (address,content) {
      return A2($Signal.message,address,Filter(content));
   });
   var filterField = F2(function (address,model) {
      return $Html.fromElement(A4($Graphics$Input$Field.field,
      $Graphics$Input$Field.defaultStyle,
      queryUpdateMessage(address),
      "Search",
      model.filterQuery));
   });
   ...
   var viewForCategory = F2(function (address,category) {
      ...
      $Signal.message(A2($Signal.forwardTo,
      address,
      ModifyCategoryColor(category.id))),
      "Color",
      category.color);
      ...
      $Signal.message(A2($Signal.forwardTo,
      address,
      ModifyCategoryName(category.id))),
      "Name",
      category.name);
   ...
   var indexButton = function (address) {
   ...
   var viewCompanies = F2(function (address,model) {
      var contactMapper = function (contact) {
         return contact.company.string;
      };
      var companies = $Set.toList($Set.fromList(A2($List.map,
      contactMapper,
      model.contacts)));
      var filteredCompanies = A2($List.filter,
      stringHasContent(model.filterQuery.string),
      companies);
      var companiesHtml = A2($List.map,
      function (company) {
         return A2($Html.li,
         _U.list([]),
         _U.list([$Html.text(company)]));
      },
      filteredCompanies);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.h3,
              _U.list([]),
              _U.list([$Html.text("All companies")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("filter_field")]),
              _U.list([A2(filterField,address,model)]))
              ,A2($Html.div,
              ...
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("plain")]),
              companiesHtml)]));
   });
   var viewTLDs = F2(function (address,model) {
      var tldMapper = function (email) {
         ...
         1,
         A2($String.split,"@",email.text.string))));
      };
   ...
   var viewAllContacts = F2(function (address,model) {
      ...
      function (_p5) {
         ...
         A2(contactWithCategory,model,_p5));
      },
      model.contacts);
      var contactsHtml = A2($List.map,
      function (_p6) {
         ...
         address,
         A2(contactWithCategory,model,_p6));
      },
      filteredContacts);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.h3,
              ...
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("category_wrapper")]),
              contactsHtml)]));
   });
   var ProcessImport = function (a) {
      return {ctor: "ProcessImport",_0: a};
   };
   ...
   var viewIndex = F2(function (address,model) {
      ...
      var showAllButton = A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,ShowAllContacts)]),
      _U.list([$Html.text("Show All Contacts")]));
      var importButton = A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,StartImport)]),
      _U.list([$Html.text("Import")]));
      ...
      _U.list([A2($Html.h3,
              _U.list([]),
              _U.list([$Html.text("All categories")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("filter_field")]),
              _U.list([A2(filterField,address,model)]))
              ,A2($Html.div,
   ...
   var initCategory = function (_p7) {
      ...
      return {name: A2($Graphics$Input$Field.Content,
             _p8._0,
             emptySelection)
             ,color: A2($Graphics$Input$Field.Content,_p8._1,emptySelection)
             ,id: _p8._2};
   };
   var emptySelection = A3($Graphics$Input$Field.Selection,
   0,
   ...
   var initContact = F2(function (id,_p9) {
      var _p10 = _p9;
      var contentInitializer = initContactContent(id);
      var newAddresses = A2($List.indexedMap,
      contentInitializer,
      _p10._2);
      var newPhones = A2($List.indexedMap,contentInitializer,_p10._3);
      var newMails = A2($List.indexedMap,contentInitializer,_p10._4);
      return {name: A2($Graphics$Input$Field.Content,
             _p10._0,
             emptySelection)
   ...
   var init = {ctor: "_Tuple2"
              ,_0: {categories: _U.list([])
                   ...
                   ,nextCategoryID: 0
                   ,nextContactID: 0
                   ,filterQuery: A2($Graphics$Input$Field.Content,
                   "",
                   ...
                   ,viewMode: Index}
              ,_1: $Effects.none};
   var processImport = function (_p11) {
      var _p12 = _p11;
      var _p17 = _p12._1;
      var _p16 = _p12._0;
      var indexRange = _U.range(0,$List.length(_p17));
      var newContacts = A3($List.map2,initContact,indexRange,_p17);
      ...
      var newCategories = A2($List.map,initCategory,_p16);
      var _p15 = init;
      var newModel = _p15._0;
      var newAction = _p15._1;
      return {ctor: "_Tuple2"
   ...
   var ContactContent = F3(function (a,b,c) {
      return {text: a,id: b,contact: c};
   });
   ...
   var Category = F3(function (a,b,c) {
      return {name: a,color: b,id: c};
   });
   ...
   var viewCompanyTLDs = F2(function (address,model) {
      ...
      _U.list([A2($Html.h3,
              _U.list([]),
              _U.list([$Html.text("Company TLDs")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("filter_field")]),
              _U.list([A2(filterField,address,model)]))
              ,A2($Html.div,
   ...
   var view = F2(function (address,model) {
      var viewFinder = function () {
         var _p18 = model.viewMode;
         switch (_p18.ctor)
         {case "Index": return viewIndex;
            case "ViewCategory": return viewCategory(_p18._0);
            case "ViewEmailList": return viewEmailList(_p18._0);
   ...
   var update = F2(function (action,model) {
      ...
      {case "Insert":
         var newCategory = initCategory(A3(F3(function (v0,v1,v2) {
           ...
           var newCategories = A2($Basics._op["++"],
           model.categories,
           _U.list([newCategory]));
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  ...
                  ,_1: $Effects.none};
         case "StartImport": return {ctor: "_Tuple2"
                                    ,_0: model
                                    ,_1: getContacts};
         case "ProcessImport": var newModel = function () {
              var _p20 = _p19._0;
              if (_p20.ctor === "Just") {
                    return processImport(_p20._0);
                 } else {
         ...
         case "Filter": return {ctor: "_Tuple2"
                               ,_0: _U.update(model,{filterQuery: _p19._0})
                               ,_1: $Effects.none};
         case "RemoveCategory": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,
                                       {categories: A2($List.filter,
                                       function (cat) {
                                          return !_U.eq(_p19._0,cat.id);
                                       },
                                       model.categories)})
                                       ,_1: $Effects.none};
         ...
         var updateCat = function (categoryModel) {
              ...
              _p19._0) ? _U.update(categoryModel,
              {name: _p19._1}) : categoryModel;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {categories: A2($List.map,updateCat,model.categories)})
                  ,_1: $Effects.none};
         case "ModifyCategoryColor":
         var updateCat = function (categoryModel) {
              return _U.eq(categoryModel.id,
              _p19._0) ? _U.update(categoryModel,
              {color: _p19._1}) : categoryModel;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {categories: A2($List.map,updateCat,model.categories)})
                  ,_1: $Effects.none};
         case "ShowIndex": return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{viewMode: Index})
                                  ,_1: $Effects.none};
         case "ShowCategory": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{viewMode: ViewCategory(_p19._0)})
                                     ,_1: $Effects.none};
         case "ShowEmailList": return {ctor: "_Tuple2"
                                      ,_0: _U.update(model,{viewMode: ViewEmailList(_p19._0)})
                                      ,_1: $Effects.none};
         ...
         case "AddContact": var newContact = A2(initContact,
           ...
           return {ctor: "_Tuple2"
                  ...
                  ,_1: $Effects.none};
         case "AddAddress": var _p21 = _p19._0;
           var contacts = A2($List.filter,
           function (con) {
              return _U.eq(_p21,con.id);
           },
           model.contacts);
           ...
           var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,_p21) ? _U.update(contactModel,
           ...
           return {ctor: "_Tuple2"
                  ...
                  ,_1: $Effects.none};
         case "AddPhone": var _p22 = _p19._0;
           var contacts = A2($List.filter,
           function (con) {
              return _U.eq(_p22,con.id);
           },
           model.contacts);
           ...
           A3(initContactContent,_p22,maxContentId(oldPhones) + 1,"Phone"),
           oldPhones);
           var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,_p22) ? _U.update(contactModel,
           ...
           return {ctor: "_Tuple2"
                  ...
                  {contacts: A2($List.map,updateContact,model.contacts)})
                  ,_1: $Effects.none};
         case "AddEmail": var _p23 = _p19._0;
           var contacts = A2($List.filter,
           function (con) {
           ...
           A3(initContactContent,_p23,maxContentId(oldEmails) + 1,"Email"),
           oldEmails);
           var updateContact = function (contactModel) {
           ...
           return {ctor: "_Tuple2"
                  ...
                  {contacts: A2($List.map,updateContact,model.contacts)})
                  ,_1: $Effects.none};
         case "RemoveAddress": var _p24 = _p19._0;
           var contacts = A2($List.filter,
           function (con) {
           ...
           return {ctor: "_Tuple2"
                  ...
                  {contacts: A2($List.map,updateContact,model.contacts)})
                  ,_1: $Effects.none};
         case "RemoveEmail": var _p25 = _p19._0;
           var contacts = A2($List.filter,
           function (con) {
           ...
           return {ctor: "_Tuple2"
                  ...
                  {contacts: A2($List.map,updateContact,model.contacts)})
                  ,_1: $Effects.none};
         case "RemovePhone": var _p26 = _p19._0;
           var contacts = A2($List.filter,
           function (con) {
         ...
         var updateContact = function (contactModel) {
              ...
              _p19._0) ? _U.update(contactModel,
              {name: _p19._1}) : contactModel;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {contacts: A2($List.map,updateContact,model.contacts)})
         ...
         var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,
              _p19._0) ? _U.update(contactModel,
              {company: _p19._1}) : contactModel;
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {contacts: A2($List.map,updateContact,model.contacts)})
                  ,_1: $Effects.none};
         default: var _p29 = _p19._0;
           var updateFunc = function (content) {
              return _U.eq(content,_p29) ? _U.update(_p29,
              {text: _p19._1}) : content;
           };
           var updateContactModel = F2(function (_p27,contactModel) {
              var _p28 = _p27;
              var contentList = _p28._0(contactModel);
              var updatedContentList = _U.eq(contactModel.id,
              _p29.contact) ? A2($List.map,
              updateFunc,
              contentList) : contentList;
              return A2(_p28._1,contactModel,updatedContentList);
           });
           var updateFuncs = _U.list([{ctor: "_Tuple2"
                                      ,_0: function (con) {
                                         return con.addresses;
                                      }
                                      ,_1: F2(function (con,val) {
                                         return _U.update(con,{addresses: val});
                                      })}
                                     ,{ctor: "_Tuple2"
                                      ,_0: function (con) {
                                         return con.phones;
                                      ...
                                      ,_1: F2(function (con,val) {
                                         return _U.update(con,{phones: val});
                                      })}
                                     ,{ctor: "_Tuple2"
                                      ,_0: function (con) {
                                         return con.emails;
                                      ...
                                      ,_1: F2(function (con,val) {
                                         return _U.update(con,{emails: val});
                                      })}]);
           var updateContact = function (contactModel) {
              return A3($List.foldl,
              updateContactModel,
...
Elm.Contacts.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $ContactBook.init
                             ,update: $ContactBook.update
                             ,view: $ContactBook.view
                             ,inputs: _U.list([])});
   var main = app.html;
