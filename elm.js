...
Elm.ContactBook.make = function (_elm) {
   ...
   A2($Json$Decode._op[":="],"company",$Json$Decode.string),
   A2($Json$Decode._op[":="],"addresses",$Json$Decode.list($Json$Decode.string)),
   A2($Json$Decode._op[":="],"phones",$Json$Decode.list($Json$Decode.string)),
   A2($Json$Decode._op[":="],"emails",$Json$Decode.list($Json$Decode.string)),
   A2($Json$Decode._op[":="],"dateOfBirth",$Json$Decode.string),
   A2($Json$Decode._op[":="],"category",$Json$Decode.$int));
   var contactsDecoder = $Json$Decode.list(contactDecoder);
   ...
   var categoriesDecoder = $Json$Decode.list(categoryDecoder);
   var contactBookDecoder = A3($Json$Decode.object2,
   F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
   A2($Json$Decode.at,_U.list(["categories"]),categoriesDecoder),
   A2($Json$Decode.at,_U.list(["contacts"]),contactsDecoder));
   var stringHasContent = F2(function (query,string) {    return A2($String.contains,$String.toLower(query),$String.toLower(string));});
   var stringsHaveContent = F2(function (query,strings) {    return A2($List.any,stringHasContent(query),strings);});
   var contactHasContent = F2(function (query,contact) {
      var contentContactFilter = function (content) {    return A2(stringHasContent,query,content.text.string);};
      return A2(stringsHaveContent,query,_U.list([contact.name.string,contact.company.string,contact.birthday.string])) || (A2($List.any,
      contentContactFilter,
      contact.addresses) || (A2($List.any,contentContactFilter,contact.emails) || A2($List.any,contentContactFilter,contact.phones)));
   });
   var categoryHasContent = F2(function (query,category) {    return A2(stringsHaveContent,query,_U.list([category.name.string,category.color.string]));});
   ...
   var maxContentId = function (list) {    return A2($Maybe.withDefault,0,$List.maximum(A2($List.map,function (_) {    return _.id;},list)));};
   ...
   var ModifyContactContent = F2(function (a,b) {    return {ctor: "ModifyContactContent",_0: a,_1: b};});
   var viewForContactContent = F3(function (address,content,removeButton) {
      return A2($Html.li,
      _U.list([]),
      _U.list([$Html.fromElement(A4($Graphics$Input$Field.field,
              $Graphics$Input$Field.defaultStyle,
              $Signal.message(A2($Signal.forwardTo,address,ModifyContactContent(content))),
              "content",
              content.text))
              ,removeButton]));
   });
   var ModifyContactCompany = F2(function (a,b) {    return {ctor: "ModifyContactCompany",_0: a,_1: b};});
   var ModifyContactBirthday = F2(function (a,b) {    return {ctor: "ModifyContactBirthday",_0: a,_1: b};});
   var ModifyContactName = F2(function (a,b) {    return {ctor: "ModifyContactName",_0: a,_1: b};});
   var RemoveContact = function (a) {    return {ctor: "RemoveContact",_0: a};};
   var RemoveEmail = F2(function (a,b) {    return {ctor: "RemoveEmail",_0: a,_1: b};});
   var RemovePhone = F2(function (a,b) {    return {ctor: "RemovePhone",_0: a,_1: b};});
   var RemoveAddress = F2(function (a,b) {    return {ctor: "RemoveAddress",_0: a,_1: b};});
   var AddEmail = function (a) {    return {ctor: "AddEmail",_0: a};};
   var AddPhone = function (a) {    return {ctor: "AddPhone",_0: a};};
   var AddAddress = function (a) {    return {ctor: "AddAddress",_0: a};};
   var viewForContact = F2(function (address,contact) {
      var addPhoneButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,AddPhone(contact.id))]),_U.list([$Html.text("Add phone")]));
      var addEmailButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,AddEmail(contact.id))]),_U.list([$Html.text("Add email")]));
      var addAddressButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,AddAddress(contact.id))]),_U.list([$Html.text("Add address")]));
      var deleteButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,RemoveContact(contact.id))]),_U.list([$Html.text("Delete")]));
      var contentViewMapper = F2(function (remAddress,content) {
         return A3(viewForContactContent,address,content,A2($Html.button,_U.list([A2($Html$Events.onClick,address,remAddress)]),_U.list([$Html.text("X")])));
      });
      var addresses = A2($List.map,function (content) {    return A2(contentViewMapper,A2(RemoveAddress,contact.id,content.id),content);},contact.addresses);
      var phones = A2($List.map,function (content) {    return A2(contentViewMapper,A2(RemovePhone,contact.id,content.id),content);},contact.phones);
      var mails = A2($List.map,function (content) {    return A2(contentViewMapper,A2(RemoveEmail,contact.id,content.id),content);},contact.emails);
      var buildDL = $List.map(function (_p0) {
         var _p1 = _p0;
         return A2($Html.li,
         _U.list([]),
         _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text(_p1._0)])),A2($Html.div,_U.list([$Html$Attributes.$class("info")]),_U.list([_p1._1]))]));
      });
      var birthdayField = A4($Graphics$Input$Field.field,
      $Graphics$Input$Field.defaultStyle,
      $Signal.message(A2($Signal.forwardTo,address,ModifyContactBirthday(contact.id))),
      "Birthday",
      contact.birthday);
      ...
      "Name",
      contact.company);
      var company = contact.company.string;
      var nameField = A4($Graphics$Input$Field.field,
      $Graphics$Input$Field.defaultStyle,
      $Signal.message(A2($Signal.forwardTo,address,ModifyContactName(contact.id))),
      "Name",
      contact.name);
      var dL = _U.list([{ctor: "_Tuple2",_0: "Name",_1: $Html.fromElement(nameField)}
                       ,{ctor: "_Tuple2",_0: "Company",_1: $Html.fromElement(companyField)}
                       ,{ctor: "_Tuple2",_0: "Birthday",_1: $Html.fromElement(birthdayField)}
                       ,{ctor: "_Tuple2",_0: "Addresses",_1: A2($Html.ul,_U.list([]),addresses)}
                       ,{ctor: "_Tuple2",_0: "Phone numbers",_1: A2($Html.ul,_U.list([]),phones)}
                       ,{ctor: "_Tuple2",_0: "E-Mails",_1: A2($Html.ul,_U.list([]),mails)}
                       ,{ctor: "_Tuple2",_0: "Actions",_1: A2($Html.span,_U.list([]),_U.list([deleteButton,addAddressButton,addEmailButton,addPhoneButton]))}]);
      var dLC = function () {
               ...
               _U.list([{ctor: "_Tuple2"
                        ...
                        _U.list([A2($Html.span,
                                _U.list([$Html$Attributes.$class("color")
                                        ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: _p3.color.string}]))]),
                                _U.list([]))
                                ,$Html.text(_p3.name.string)]))}]));
            } else {
               return dL;
            }
      }();
      var name = contact.name.string;
      return A2($Html.li,_U.list([]),_U.list([A2($Html.ul,_U.list([$Html$Attributes.$class("contact")]),buildDL(dLC))]));
   });
   var AddContact = function (a) {    return {ctor: "AddContact",_0: a};};
   ...
   var RemoveCategory = function (a) {    return {ctor: "RemoveCategory",_0: a};};
   ...
   var filterField = F2(function (address,model) {
      return $Html.fromElement(A4($Graphics$Input$Field.field,$Graphics$Input$Field.defaultStyle,queryUpdateMessage(address),"Search",model.filterQuery));
   });
   ...
   var ShowEmailList = function (a) {    return {ctor: "ShowEmailList",_0: a};};
   ...
   var viewForCategory = F2(function (address,category) {
      ...
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("category")]),
      _U.list([A2($Html.h4,
              _U.list([]),
              _U.list([A2($Html.span,
   ...
   var viewCategory = F3(function (category,address,model) {
      var id = $Basics.toString(category.id);
      var mailButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,ShowEmailList(category))]),_U.list([$Html.text("Send eMail")]));
      var addButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,AddContact(category))]),_U.list([$Html.text("Add")]));
      ...
      _U.list([A2($Html.h3,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],"Category \'",A2($Basics._op["++"],category.name.string,"\'")))
                      ,A2($Html.span,
                      _U.list([$Html$Attributes.$class("color")
                              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: category.color.string}]))]),
                      _U.list([]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("filter_field")]),_U.list([A2(filterField,address,model)]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("actions")]),_U.list([indexButton(address),addButton,mailButton]))
   ...
   var viewEmailList = F3(function (category,address,model) {
      ...
      var mailGrabber = function (contact) {
         return A2($Maybe.withDefault,"",A2($Maybe.map,function (n) {    return n.text.string;},$List.head(contact.emails)));
      };
      var notEmpty = function (string) {    return $Basics.not($String.isEmpty(string));};
      var emailList = A2($String.join,", ",A2($List.filter,notEmpty,A2($List.map,mailGrabber,mappedContacts)));
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.h3,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],"All e-mail addresses in \'",A2($Basics._op["++"],category.name.string,"\'")))
                      ,A2($Html.span,
                      _U.list([$Html$Attributes.$class("color")
                              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: category.color.string}]))]),
                      _U.list([]))]))
              ...
              _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,ShowCategory(category))]),_U.list([$Html.text("Back")])),indexButton(address)]))
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.textarea,_U.list([$Html$Attributes.$class("full_size")]),_U.list([$Html.text(emailList)]))]));
   });
   var viewCompanies = F2(function (address,model) {
      var contactMapper = function (contact) {    return contact.company.string;};
      var companies = $Set.toList($Set.fromList(A2($List.map,contactMapper,model.contacts)));
      var filteredCompanies = A2($List.filter,stringHasContent(model.filterQuery.string),companies);
      var companiesHtml = A2($List.map,function (company) {    return A2($Html.li,_U.list([]),_U.list([$Html.text(company)]));},filteredCompanies);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("All companies")]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("filter_field")]),_U.list([A2(filterField,address,model)]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("actions")]),_U.list([indexButton(address)]))
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("plain")]),companiesHtml)]));
   });
   var viewTLDs = F2(function (address,model) {
      var tldMapper = function (email) {    return A2($Maybe.withDefault,"",$List.head(A2($List.drop,1,A2($String.split,"@",email.text.string))));};
      var contactToTLDMapper = function (contact) {    return A2($List.map,tldMapper,contact.emails);};
      ...
      $Set.toList(A2($Set.remove,"",$Set.fromList($List.concat(A2($List.map,contactToTLDMapper,model.contacts)))))));
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("All TLDs")]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("filter_field")]),_U.list([A2(filterField,address,model)]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("actions")]),_U.list([indexButton(address)]))
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("plain")]),tldsHtml)]));
   });
   var viewAllContacts = F2(function (address,model) {
      ...
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("All contacts")]))
              ...
              ,A2($Html.div,_U.list([$Html$Attributes.$class("actions")]),_U.list([indexButton(address)]))
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("category_wrapper")]),contactsHtml)]));
   });
   ...
   var viewIndex = F2(function (address,model) {
      var showCompanyTLDsButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,ShowCompanyTLDs)]),_U.list([$Html.text("Show Company TLDs")]));
      var showTLDsButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,ShowTLDs)]),_U.list([$Html.text("Show All TLDs")]));
      var showCompaniesButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,ShowAllCompanies)]),_U.list([$Html.text("Show All Companies")]));
      var showAllButton = A2($Html.button,_U.list([A2($Html$Events.onClick,address,ShowAllContacts)]),_U.list([$Html.text("Show All Contacts")]));
      ...
      var filteredCategories = $List.reverse(A2($List.filter,categoryHasContent(model.filterQuery.string),model.categories));
      var categories = A2($List.map,function (cat) {    return A2(viewForCategory,address,cat);},filteredCategories);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("All categories")]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("filter_field")]),_U.list([A2(filterField,address,model)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("actions")]),
              _U.list([importButton,insert,showAllButton,showCompaniesButton,showTLDsButton,showCompanyTLDsButton]))
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.ul,_U.list([]),categories)]));
   });
   var initCategory = function (_p5) {
      var _p6 = _p5;
      var emptySelection = A3($Graphics$Input$Field.Selection,0,0,$Graphics$Input$Field.Forward);
      return {name: A2($Graphics$Input$Field.Content,_p6._0,emptySelection),color: A2($Graphics$Input$Field.Content,_p6._1,emptySelection),id: _p6._2};
   };
   var emptySelection = A3($Graphics$Input$Field.Selection,0,0,$Graphics$Input$Field.Forward);
   var initContactContent = F3(function (contact,id,text) {    return {id: id,contact: contact,text: A2($Graphics$Input$Field.Content,text,emptySelection)};});
   var initContact = F2(function (id,_p7) {
      var _p8 = _p7;
      var contentInitializer = initContactContent(id);
      var newAddresses = A2($List.indexedMap,contentInitializer,_p8._2);
      var newPhones = A2($List.indexedMap,contentInitializer,_p8._3);
      var newMails = A2($List.indexedMap,contentInitializer,_p8._4);
      return {name: A2($Graphics$Input$Field.Content,_p8._0,emptySelection)
             ,company: A2($Graphics$Input$Field.Content,_p8._1,emptySelection)
             ,addresses: newAddresses
             ,phones: newPhones
             ,emails: newMails
             ,birthday: A2($Graphics$Input$Field.Content,_p8._5,emptySelection)
             ,category: _p8._6
   ...
   var ViewEmailList = function (a) {    return {ctor: "ViewEmailList",_0: a};};
   ...
   var init = {ctor: "_Tuple2"
              ,_0: {categories: _U.list([])
                   ...
                   ,viewMode: Index}
              ,_1: $Effects.none};
   var processImport = function (_p9) {
      var _p10 = _p9;
      var _p15 = _p10._1;
      var _p14 = _p10._0;
      var indexRange = _U.range(0,$List.length(_p15));
      var newContacts = A3($List.map2,initContact,indexRange,_p15);
      var newNextContactID = $List.length(indexRange);
      var ids = A2($List.map,function (_p11) {    var _p12 = _p11;return _p12._2;},_p14);
      var catMaxId = A2($Maybe.withDefault,0,$List.maximum(ids));
      var newCategories = A2($List.map,initCategory,_p14);
      var _p13 = init;
      var newModel = _p13._0;
      var newAction = _p13._1;
      return {ctor: "_Tuple2"
   ...
   var ContactContent = F3(function (a,b,c) {    return {text: a,id: b,contact: c};});
   var Contact = F9(function (a,b,c,d,e,f,g,h,i) {
      return {name: a,company: b,addresses: c,phones: d,emails: e,birthday: f,category: g,categoryObject: h,id: i};
   });
   ...
   var domainsToFilter = _U.list(["web.de","gmail.com","t-online.de","gmx.net","gmx.de","googlemail.com","arcor.de","alice-dsl.de"]);
   var viewCompanyTLDs = F2(function (address,model) {
      var tldFilter = function (mail) {
         return $Basics.not(A3($List.foldr,F2(function (a,b) {    return a || b;}),false,A2($List.map,stringHasContent(mail),domainsToFilter)));
      };
      var tldMapper = function (email) {    return A2($Maybe.withDefault,"",$List.head(A2($List.drop,1,A2($String.split,"@",email.text.string))));};
      var contactToTLDMapper = function (contact) {    return A2($List.map,tldMapper,contact.emails);};
      var tldsHtml = A2($List.map,
      ...
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("Company TLDs")]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("filter_field")]),_U.list([A2(filterField,address,model)]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("actions")]),_U.list([indexButton(address)]))
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("plain")]),tldsHtml)]));
   ...
   var view = F2(function (address,model) {
      var viewFinder = function () {
         var _p16 = model.viewMode;
         switch (_p16.ctor)
         {case "Index": return viewIndex;
            case "ViewCategory": return viewCategory(_p16._0);
            case "ViewEmailList": return viewEmailList(_p16._0);
   ...
   var update = F2(function (action,model) {
      ...
      {case "Insert": var newCategory = initCategory(A3(F3(function (v0,v1,v2) {    return {ctor: "_Tuple3",_0: v0,_1: v1,_2: v2};}),
         ...
         case "ProcessImport": var newModel = function () {
              var _p18 = _p17._0;
              if (_p18.ctor === "Just") {
                    return processImport(_p18._0);
                 } else {
                    return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                 }
           }();
           return newModel;
         case "Filter": return {ctor: "_Tuple2",_0: _U.update(model,{filterQuery: _p17._0}),_1: $Effects.none};
         case "RemoveCategory": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{categories: A2($List.filter,function (cat) {    return !_U.eq(_p17._0,cat.id);},model.categories)})
                                       ,_1: $Effects.none};
         case "ModifyCategoryName": var updateCat = function (categoryModel) {
              return _U.eq(categoryModel.id,_p17._0) ? _U.update(categoryModel,{name: _p17._1}) : categoryModel;
           };
         ...
         case "ModifyCategoryColor": var updateCat = function (categoryModel) {
              return _U.eq(categoryModel.id,_p17._0) ? _U.update(categoryModel,{color: _p17._1}) : categoryModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{categories: A2($List.map,updateCat,model.categories)}),_1: $Effects.none};
         case "ShowIndex": return {ctor: "_Tuple2",_0: _U.update(model,{viewMode: Index}),_1: $Effects.none};
         case "ShowCategory": return {ctor: "_Tuple2",_0: _U.update(model,{viewMode: ViewCategory(_p17._0)}),_1: $Effects.none};
         case "ShowEmailList": return {ctor: "_Tuple2",_0: _U.update(model,{viewMode: ViewEmailList(_p17._0)}),_1: $Effects.none};
         case "ShowAllContacts": return {ctor: "_Tuple2",_0: _U.update(model,{viewMode: ViewAllContacts}),_1: $Effects.none};
         case "ShowAllCompanies": return {ctor: "_Tuple2",_0: _U.update(model,{viewMode: ViewAllCompanies}),_1: $Effects.none};
         case "ShowTLDs": return {ctor: "_Tuple2",_0: _U.update(model,{viewMode: ViewTLDs}),_1: $Effects.none};
         case "ShowCompanyTLDs": return {ctor: "_Tuple2",_0: _U.update(model,{viewMode: ViewCompanyTLDs}),_1: $Effects.none};
         case "AddContact": var newContact = A2(initContact,
           model.nextContactID,
           {ctor: "_Tuple7",_0: "",_1: "",_2: _U.list([]),_3: _U.list([]),_4: _U.list([]),_5: "",_6: _p17._0.id});
           var newContacts = A2($Basics._op["++"],_U.list([newContact]),model.contacts);
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: newContacts,nextContactID: model.nextContactID + 1}),_1: $Effects.none};
         case "AddAddress": var _p19 = _p17._0;
           var contacts = A2($List.filter,function (con) {    return _U.eq(_p19,con.id);},model.contacts);
           var oldAddresses = $List.concat(A2($List.map,function (con) {    return con.addresses;},contacts));
           var newAddresses = A2($List._op["::"],A3(initContactContent,_p19,maxContentId(oldAddresses) + 1,"Address"),oldAddresses);
           var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,_p19) ? _U.update(contactModel,{addresses: newAddresses}) : contactModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "AddPhone": var _p20 = _p17._0;
           var contacts = A2($List.filter,function (con) {    return _U.eq(_p20,con.id);},model.contacts);
           var oldPhones = $List.concat(A2($List.map,function (con) {    return con.phones;},contacts));
           var newPhones = A2($List._op["::"],A3(initContactContent,_p20,maxContentId(oldPhones) + 1,"Phone"),oldPhones);
           var updateContact = function (contactModel) {    return _U.eq(contactModel.id,_p20) ? _U.update(contactModel,{phones: newPhones}) : contactModel;};
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "AddEmail": var _p21 = _p17._0;
           var contacts = A2($List.filter,function (con) {    return _U.eq(_p21,con.id);},model.contacts);
           var oldEmails = $List.concat(A2($List.map,function (con) {    return con.emails;},contacts));
           var newEmails = A2($List._op["::"],A3(initContactContent,_p21,maxContentId(oldEmails) + 1,"Email"),oldEmails);
           var updateContact = function (contactModel) {    return _U.eq(contactModel.id,_p21) ? _U.update(contactModel,{emails: newEmails}) : contactModel;};
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "RemoveAddress": var _p22 = _p17._0;
           var contacts = A2($List.filter,function (con) {    return _U.eq(_p22,con.id);},model.contacts);
           var oldAddresses = $List.concat(A2($List.map,function (con) {    return con.addresses;},contacts));
           var newAddresses = A2($List.filter,function (con) {    return !_U.eq(_p17._1,con.id);},oldAddresses);
           var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,_p22) ? _U.update(contactModel,{addresses: newAddresses}) : contactModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "RemoveEmail": var _p23 = _p17._0;
           var contacts = A2($List.filter,function (con) {    return _U.eq(_p23,con.id);},model.contacts);
           var oldEmails = $List.concat(A2($List.map,function (con) {    return con.emails;},contacts));
           var newEmails = A2($List.filter,function (con) {    return !_U.eq(_p17._1,con.id);},oldEmails);
           var updateContact = function (contactModel) {    return _U.eq(contactModel.id,_p23) ? _U.update(contactModel,{emails: newEmails}) : contactModel;};
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "RemovePhone": var _p24 = _p17._0;
           var contacts = A2($List.filter,function (con) {    return _U.eq(_p24,con.id);},model.contacts);
           var oldPhones = $List.concat(A2($List.map,function (con) {    return con.phones;},contacts));
           var newPhones = A2($List.filter,function (con) {    return !_U.eq(_p17._1,con.id);},oldPhones);
           var updateContact = function (contactModel) {    return _U.eq(contactModel.id,_p24) ? _U.update(contactModel,{phones: newPhones}) : contactModel;};
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "RemoveContact": return {ctor: "_Tuple2"
                                      ,_0: _U.update(model,{contacts: A2($List.filter,function (con) {    return !_U.eq(_p17._0,con.id);},model.contacts)})
                                      ,_1: $Effects.none};
         case "ModifyContactName": var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,_p17._0) ? _U.update(contactModel,{name: _p17._1}) : contactModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "ModifyContactBirthday": var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,_p17._0) ? _U.update(contactModel,{birthday: _p17._1}) : contactModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         case "ModifyContactCompany": var updateContact = function (contactModel) {
              return _U.eq(contactModel.id,_p17._0) ? _U.update(contactModel,{company: _p17._1}) : contactModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};
         default: var _p27 = _p17._0;
           var updateFunc = function (content) {    return _U.eq(content,_p27) ? _U.update(_p27,{text: _p17._1}) : content;};
           var updateContactModel = F2(function (_p25,contactModel) {
              var _p26 = _p25;
              var contentList = _p26._0(contactModel);
              var updatedContentList = _U.eq(contactModel.id,_p27.contact) ? A2($List.map,updateFunc,contentList) : contentList;
              return A2(_p26._1,contactModel,updatedContentList);
           });
           var updateFuncs = _U.list([{ctor: "_Tuple2"
                                      ,_0: function (con) {
                                         return con.addresses;
                                      }
                                      ,_1: F2(function (con,val) {    return _U.update(con,{addresses: val});})}
                                     ,{ctor: "_Tuple2"
                                      ,_0: function (con) {
                                         return con.phones;
                                      }
                                      ,_1: F2(function (con,val) {    return _U.update(con,{phones: val});})}
                                     ,{ctor: "_Tuple2"
                                      ,_0: function (con) {
                                         return con.emails;
                                      }
                                      ,_1: F2(function (con,val) {    return _U.update(con,{emails: val});})}]);
           var updateContact = function (contactModel) {    return A3($List.foldl,updateContactModel,contactModel,updateFuncs);};
           return {ctor: "_Tuple2",_0: _U.update(model,{contacts: A2($List.map,updateContact,model.contacts)}),_1: $Effects.none};}
   });
   return _elm.ContactBook.values = {_op: _op
                                    ...
                                    ,initContactContent: initContactContent
                                    ,Insert: Insert
                                    ...
                                    ,ModifyContactContent: ModifyContactContent
                                    ,update: update
                                    ...
                                    ,stringsHaveContent: stringsHaveContent
                                    ,stringHasContent: stringHasContent
