...
Elm.ContactBook.make = function (_elm) {
   ...
   var contactHasContent = F2(function (query,contact) {
      ...
      $String.toLower(contact.name.string)) || A2($String.contains,
      $String.toLower(query),
   ...
   var categoryHasContent = F2(function (query,category) {
      return A2($String.contains,
      $String.toLower(query),
      $String.toLower(category.name.string)) || A2($String.contains,
      query,
   ...
   var viewForContactContent = F2(function (address,content) {
      ...
      _U.list([A2($Html.div,
      _U.list([]),
      _U.list([$Html.fromElement(contentField)
              ,$Html.text(A2($Basics._op["++"],
              " id: ",
              $Basics.toString(content.id)))]))]));
   });
   var viewForContact = F2(function (address,contact) {
      ...
      _U.list([A2($Html.div,
              ...
              A2($Basics._op["++"],
              contact.name.string,
              A2($Basics._op["++"],", company: ",contact.company.string))))]))
   ...
   var viewCategory = F3(function (address,category,model) {
      var id = $Basics.toString(category.id);
      var filterField = A4($Graphics$Input$Field.field,
      $Graphics$Input$Field.defaultStyle,
   ...
   var viewIndex = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([$Html.fromElement(filterField)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("actions")]),
              _U.list([importButton,insert]))
